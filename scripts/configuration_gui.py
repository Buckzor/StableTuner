...
class App(ctk.CTk):    
    ...
    def create_trainer_settings_widgets(self):
        ...
        self.token_limit_label = ctk.CTkLabel(self.training_frame_finetune_subframe, text="Token Limit")
        ...
        self.token_limit_entry = ctk.CTkEntry(self.training_frame_finetune_subframe, placeholder_text='test')
